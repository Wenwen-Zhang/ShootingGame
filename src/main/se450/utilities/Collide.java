...
/**
 * Check the collision between two LineCollection objects. 
 * 
 */
public class Collide 
{
    ...
    /**
     * Passing two LineCollection objects as parameters to check if they collide with each other.
     * @param collectionA the LineCollection object
     * @param collectionB the LineCollection object obtained from another object that is being tested for collision
     * @return a boolean value: true if the two LineCollection objects collided.
     */
