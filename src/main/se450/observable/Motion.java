	...
	private void startMotion()
	{
		...
		if(configurationManager != null) 
		{
			...
			if (configuration != null) {
				...
				int nFramesPerSecond = configuration.getFramesPerSecond();
				
				if (nFramesPerSecond > 0)
				{
					if (scheduler == null)
					{
						...
						if (scheduler != null)
							scheduler.scheduleAtFixedRate(this, 0, NANO_SECONDS_PER_SECOND / nFramesPerSecond, TimeUnit.NANOSECONDS);//~20 frames per second
					}
				}
		    }			
		}	    
